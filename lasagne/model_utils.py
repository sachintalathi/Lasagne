...
def get_conv_macs_size(l):
	Data={}
	count=0
	if 'CONV' in l.__module__.upper():
		Data['layer_name']='convolution'
		Data['channels']=l.input_shape[1]
		Data['filters']=l.output_shape[1]
		Data['kernel_x']=l.filter_size[0]
		Data['kernel_y']=l.filter_size[1]
		Data['img_y']=l.output_shape[2]
		Data['img_x']=l.output_shape[3]
...
def get_dense_mac_size(l):
	Data={}
	if 'DENSE' in l.__module__.upper():
